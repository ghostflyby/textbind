...
enum class Key(val value: Int) {
  ...
  operator fun invoke(): KeyCombination = KeyCombination(this)
  private fun control(): KeyCombination {
    return KeyCombination(this).control
  }
  ...
  private fun shift(): KeyCombination {
    return KeyCombination(this).shift
  }
  ...
  private fun menu(): KeyCombination {
    return KeyCombination(this).menu
  }
  ...
  private fun meta(): KeyCombination {
    return KeyCombination(this).meta
  }
  ...
  private fun usual(): KeyCombination {
